...
import { UserSetup } from '@/types/onboarding'
  ...
  return (
    <div className="space-y-6">
      <Alert>
        ...
        <AlertDescription>
          This admin account will have full system access. You can add more users later in Settings.
        </AlertDescription>
      </Alert>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            placeholder="admin@sandboxhotel.com"
          />
