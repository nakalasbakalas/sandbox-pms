...
export function BoardStatsBar({ stats }: BoardStatsBarProps) {
  ...
  return (
    <div className="grid grid-cols-6 gap-2">
      <Card className="p-2 border-l-2 border-l-primary shadow-none hover:shadow-sm transition-shadow">
        <div className="flex items-center gap-2">
          <div className="p-1.5 rounded bg-primary/10 flex-shrink-0">
            <Users weight="bold" className="w-3.5 h-3.5 text-primary" />
          </div>
          <div className="min-w-0">
            <div className="text-lg font-bold leading-none">{stats.occupied}</div>
            <div className="text-[9px] font-medium text-muted-foreground mt-0.5 uppercase tracking-wide">Occupied</div>
          </div>
        </div>
      </Card>

      <Card className="p-2 border-l-2 border-l-green-600 shadow-none hover:shadow-sm transition-shadow">
        <div className="flex items-center gap-2">
          <div className="p-1.5 rounded bg-green-600/10 flex-shrink-0">
            <DoorOpen weight="bold" className="w-3.5 h-3.5 text-green-700" />
          </div>
          <div className="min-w-0">
            <div className="text-lg font-bold leading-none">{stats.vacant}</div>
            <div className="text-[9px] font-medium text-muted-foreground mt-0.5 uppercase tracking-wide">Vacant</div>
          </div>
        </div>
      </Card>

      <Card className="p-2 border-l-2 border-l-emerald-600 shadow-none hover:shadow-sm transition-shadow">
        <div className="flex items-center gap-2">
          <div className="p-1.5 rounded bg-emerald-600/10 flex-shrink-0">
            <TrendUp weight="bold" className="w-3.5 h-3.5 text-emerald-700" />
          </div>
          <div className="min-w-0">
            <div className="text-lg font-bold leading-none">{stats.arrivalsToday}</div>
            <div className="text-[9px] font-medium text-muted-foreground mt-0.5 uppercase tracking-wide">Arrivals</div>
          </div>
        </div>
      </Card>

      <Card className="p-2 border-l-2 border-l-red-600 shadow-none hover:shadow-sm transition-shadow">
        <div className="flex items-center gap-2">
          <div className="p-1.5 rounded bg-red-600/10 flex-shrink-0">
            <TrendDown weight="bold" className="w-3.5 h-3.5 text-red-700" />
          </div>
          <div className="min-w-0">
            <div className="text-lg font-bold leading-none">{stats.departuresToday}</div>
            <div className="text-[9px] font-medium text-muted-foreground mt-0.5 uppercase tracking-wide">Departures</div>
          </div>
        </div>
      </Card>

      <Card className="p-2 border-l-2 border-l-orange-600 shadow-none hover:shadow-sm transition-shadow">
        <div className="flex items-center gap-2">
          <div className="p-1.5 rounded bg-orange-600/10 flex-shrink-0">
            <Broom weight="bold" className="w-3.5 h-3.5 text-orange-700" />
          </div>
          <div className="min-w-0">
            <div className="text-lg font-bold leading-none">{stats.dirty}</div>
      ...
      <Card className={cn(
        "p-2 border-l-2 shadow-none hover:shadow-sm transition-shadow",
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="min-w-0">
            <div className={cn("text-lg font-bold leading-none", occupancyColor)}>
