...
export function RatePushPanel() {
  ...
  const hasPushData = pushLogs.length > 0
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <span className="text-2xl font-bold">{hasPushData ? `${successRate}%` : 'No data'}</span>
                <CheckCircle className="w-5 h-5 text-green-600" />
              </div>
              <Progress value={hasPushData ? successRate : 0} className="h-1" />
            </div>
          </CardContent>
        </Card>
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Button
                ...
                disabled={connectedChannels.length === 0 || roomTypes.length === 0}
              >
