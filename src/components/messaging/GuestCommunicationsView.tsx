          ...
          <Card className="p-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <Input placeholder="Sandbox Hotel" className="mt-1" />
              </div>
              <div>
                <Label>Sender Email</Label>
                <Input type="email" placeholder="noreply@sandboxhotel.com" className="mt-1" />
              </div>
              <div>
                <Label>Reply-To Email</Label>
                <Input type="email" placeholder="info@sandboxhotel.com" className="mt-1" />
              </div>
