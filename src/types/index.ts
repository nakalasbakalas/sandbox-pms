...
export type BookingSource = 'DIRECT' | 'BOOKING_COM' | 'AGODA' | 'TRIP' | 'EXPEDIA' | 'AIRBNB' | 'WALK_IN' | 'PHONE' | 'OTHER'
...
export type ChannelProvider = 'BOOKING_COM' | 'AGODA' | 'TRIP' | 'EXPEDIA' | 'AIRBNB'
