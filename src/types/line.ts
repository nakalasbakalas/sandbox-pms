...
📞 +66 76 123 456`,
    variables: [
      { key: 'guestName', label: 'Guest Name', type: 'text', required: true, example: 'John Smith' },
      ...
      { key: 'checkoutTime', label: 'Check-out Time', type: 'text', required: true, example: '11:00' },
