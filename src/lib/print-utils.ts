  ...
  const html = `
    ...
    <html>
      ...
      <body>
        ...
        <div class="footer">
          Sandbox Hotel PMS • Housekeeping Report • Page 1 of 1
        </div>
      </body>
    </html>
  `
  ...
  const html = `
    ...
    <html>
      ...
      <body>
        ...
        <div class="footer">
          Sandbox Hotel PMS • Reservations Report • Confidential
        </div>
      </body>
    </html>
  `
  ...
  const html = `
    ...
    <html>
      ...
      <body>
        ...
        <div class="footer">
          <p><strong>Sandbox Hotel</strong></p>
          <p>123 Beach Road, Paradise Island</p>
          <p>Phone: +66-2-123-4567 | Email: reservations@sandboxhotel.com</p>
