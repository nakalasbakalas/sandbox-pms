...
const propertySeed = {
  ...
  operationalSettings: {
    rates: {
      ...
      notes: [
        'Standard Twin / Room Only base rate is THB 750 and minimum rate is THB 550.',
        'Superior Double / Room Only base rate is THB 850, aligned to the 2027 demand-calendar preload baseline.',
      ],
    },
    paymentMethods: {
      enabledCards: [
