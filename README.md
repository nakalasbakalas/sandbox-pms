# Hotel PMS
Property management system for boutique hotel operations.
## Database Workflow

Local disposable PostgreSQL, Prisma seed modes, Render database wiring, and guarded database-mutating E2E are documented in [docs/database.md](docs/database.md). Windows Docker setup is documented in [docs/docker-setup-windows.md](docs/docker-setup-windows.md).
...
Run mutating E2E only with an explicit disposable or staging database:
