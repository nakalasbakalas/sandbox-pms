...
- In server mode, Settings, Booking Board/Front Desk lifecycle handoffs, Cashier folio selection, housekeeping, and Night Audit use backend authority; disposable-browser coverage is engineering evidence and does not replace staff workflow acceptance on the exact release candidate.
