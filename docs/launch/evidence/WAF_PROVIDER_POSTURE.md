...
| `render deploys list srv-d6ns31h4tr6s73c9i8g0 -o json` | Passed | Current long-term custom-domain service deploy is `dep-d93t86hkh4rs73e0io4g`, status `live`, commit `163d49c2ff58eef5447e93f07d42babbf3b59d58`, finished `2026-07-03T15:26:55Z`. |
...
- Current live deploy for that service: `dep-d93t86hkh4rs73e0io4g`, commit `163d49c2ff58eef5447e93f07d42babbf3b59d58`.
...
- `docs/disaster-recovery.md` was updated to use the current live deploy `dep-d93t86hkh4rs73e0io4g` as the latest health-checked live deploy reference.
