...
| Live first-run setup completion gate | Blocked until publish/deploy/reprobe | Current branch `codex/setup-gate-launch-proof` isolates the completed-setup rejection hardening and evidence docs, but live services remain on older commits and unauthenticated setup-complete still returns payload validation; see `docs/launch/evidence/2026-07-02-slice-5d-live-deploy-drift-reprobe.md`, `docs/launch/evidence/2026-07-02-slice-5e-origin-sync-deploy-boundary.md`, and `docs/launch/evidence/2026-07-02-slice-5g-focused-publishable-changeset.md`. | Approved publish/deploy evidence plus public unauthenticated setup-complete reprobe showing rejection before payload validation. |
