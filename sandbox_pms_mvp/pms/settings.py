...
APP_SETTINGS_SEED = [
    ("hotel.name", {"value": "My Hotel"}, "string", "Hotel name", True, 1),
    ...
    ("hotel.min_nightly_rate", {"value": "0.00"}, "money", "Minimum nightly rate floor — discounts cannot push below this (0 = no floor)", False, 10),
    ("hotel.overbooking_allowed", {"value": False}, "boolean", "Overbooking policy", False, 11),
    ("reservation.code_prefix", {"value": "RES"}, "string", "Reservation code prefix", False, 11),
    ...
    ("hotel.contact_phone", {"value": ""}, "string", "Public reservation contact phone", True, 20),
    ("hotel.contact_email", {"value": ""}, "string", "Public reservation contact email", True, 21),
    ...
    ("hotel.address", {"value": ""}, "string", "Hotel address", True, 24),
    ("hotel.logo_url", {"value": ""}, "string", "Hotel logo URL", True, 25),
    ("hotel.tax_id", {"value": ""}, "string", "Tax or business display identifier", True, 26),
    ("hotel.brand_mark", {"value": ""}, "string", "Short hotel brand mark", True, 27),
    ...
    ("notifications.sender_name", {"value": "Hotel"}, "string", "Display sender name for guest communications", False, 33),
