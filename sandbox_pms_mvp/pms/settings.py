...
APP_SETTINGS_SEED = [
    ...
    ("hotel.contact_phone", {"value": "+66 2 123 4567"}, "string", "Public reservation contact phone", True, 20),
    ("hotel.contact_email", {"value": "reservations@sandboxhotel.com"}, "string", "Public reservation contact email", True, 21),
