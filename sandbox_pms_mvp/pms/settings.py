...
APP_SETTINGS_SEED = [
    ...
    ("hotel.contact_phone", {"value": "+66-2-000-0000"}, "string", "Public reservation contact phone", True, 20),
    ("hotel.contact_email", {"value": "reservations@sandbox.hotel"}, "string", "Public reservation contact email", True, 21),
